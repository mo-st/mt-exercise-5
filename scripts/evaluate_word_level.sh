...
model_name=transformer_word_level
...
CUDA_VISIBLE_DEVICES=$device OMP_NUM_THREADS=$num_threads python -m joeynmt translate $configs/$model_name.yaml < $myData/test.tok.en-de.$src > $translations_sub/test.tokenized.$model_name.$trg
