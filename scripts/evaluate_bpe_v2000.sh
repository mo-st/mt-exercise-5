...
model_name=transformer_bpe_v2000
...
CUDA_VISIBLE_DEVICES=$device OMP_NUM_THREADS=$num_threads python -m joeynmt translate $configs/$model_name.yaml < $myData/test.bpe.en-de.$src > $translations_sub/test.bpe.$model_name.$trg
